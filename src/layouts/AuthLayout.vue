<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    >
      ...
      >
        <b style="font-size: x-large; color:blue;">My Fitness</b>
        <!--begin::Logo-->
        <router-link to="/sign-in" class="mb-0 mb-lg-12">
          <img
            alt="Logo"
            :src="getAssetPath('media/misc/weightlifting.png')"
            class="h-300px h-lg-300px"
          />
        </router-link>
