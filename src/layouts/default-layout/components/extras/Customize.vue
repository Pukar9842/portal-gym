          ...
          <form class="form" id="kt_app_layout_builder_form">
            ...
            <div class="card-body p-0">
              ...
              <div class="form-group">
                <!--begin::Heading-->
                <div class="d-flex flex-column mb-4">
                  <h4 class="fw-bold text-gray-900">Icons Style</h4>
                  <div>
              ...
              <div class="form-group">
                ...
                <div class="d-flex">
                  ...
                  >
                    ...
                    <label
                      class="form-check-label text-gray-700 fw-bold text-nowrap"
                      for="kt_builder_keenthemes_icons"
                      >Themes Icons</label
                    >
                    <!--end::Label-->
                  </div>
                  ...
                  >
                    ...
                    <label
                      class="form-check-label text-gray-700 fw-bold text-nowrap"
                      for="kt_builder_bootstrap_icons"
              ...
              <div class="form-group">
                ...
                <div class="mb-6">
                  ...
                  <router-link to="/builder" class="text-primary"></router-link>
                </div>
                <!--end::Heading-->
                <!--begin::Options-->
                <div
